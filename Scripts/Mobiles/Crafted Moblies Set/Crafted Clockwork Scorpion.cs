...
namespace Server.Mobiles
{
	...
	public class CraftedClockworkScorpion : BaseCreature
	{
		[Constructable]
		public CraftedClockworkScorpion() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
		...
		public CraftedClockworkScorpion( Serial serial ) : base( serial )
		{
		}
