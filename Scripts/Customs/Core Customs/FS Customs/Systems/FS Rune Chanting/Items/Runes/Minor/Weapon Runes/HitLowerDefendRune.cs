...
{
	public class HitLowerDefendRune : BaseMinorRune
	{
		[Constructable]
		public HitLowerDefendRune() : base()
		{
			BaseAmount = 1;
			MaxAmount = 50;
		}

		public HitLowerDefendRune( Serial serial ) : base( serial )
		{
		}
		...
		public override void GetProperties( ObjectPropertyList list )
		{
			...
			list.Add( 1060425, this.BaseAmount.ToString() ); // hit lower defense ~1_val~%
		}
				...
				if ( item is BaseWeapon )
				{
					...
					else
					{
						...
						if ( item is BaseWeapon )
						{
							...
							if ( i.WeaponAttributes.HitLowerDefend + value <= max )
								i.WeaponAttributes.HitLowerDefend += value;
							else
								i.WeaponAttributes.HitLowerDefend = max;
						}
