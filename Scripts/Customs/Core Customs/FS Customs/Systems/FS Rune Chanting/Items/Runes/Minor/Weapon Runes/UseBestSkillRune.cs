...
{
	public class UseBestSkillRune : BaseMinorRune
	{
		[Constructable]
		public UseBestSkillRune() : base()
		{
			BaseAmount = 1;
			MaxAmount = 50;
		}

		public UseBestSkillRune( Serial serial ) : base( serial )
		{
		}
				...
				if ( item is BaseWeapon )
				{
					...
					else
					{
						...
						if ( item is BaseWeapon )
						{
							...
							if ( i.WeaponAttributes.UseBestSkill + value <= max )
								i.WeaponAttributes.UseBestSkill += value;
							else
								i.WeaponAttributes.UseBestSkill = max;
						}
