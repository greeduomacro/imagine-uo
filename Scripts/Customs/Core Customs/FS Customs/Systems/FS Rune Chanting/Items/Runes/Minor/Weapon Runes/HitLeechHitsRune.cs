...
{
	public class HitLeechHitsRune : BaseMinorRune
	{
		[Constructable]
		public HitLeechHitsRune() : base()
		{
			BaseAmount = 1;
			MaxAmount = 50;
		}

		public HitLeechHitsRune( Serial serial ) : base( serial )
		{
		}
		...
		public override void GetProperties( ObjectPropertyList list )
		{
			...
			list.Add( 1060422, this.BaseAmount.ToString() ); // hit life leech ~1_val~%
		}
				...
				if ( item is BaseWeapon )
				{
					...
					else
					{
						...
						if ( item is BaseWeapon )
						{
							...
							if ( i.WeaponAttributes.HitLeechHits + value <= max )
								i.WeaponAttributes.HitLeechHits += value;
							else
								i.WeaponAttributes.HitLeechHits = max;
						}
