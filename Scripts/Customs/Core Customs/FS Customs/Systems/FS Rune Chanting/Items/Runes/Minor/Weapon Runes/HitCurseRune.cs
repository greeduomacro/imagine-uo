...
{
	public class HitCurseRune : BaseMinorRune
	{
		[Constructable]
		public HitCurseRune() : base()
		{
			BaseAmount = 1;
			MaxAmount = 50;
		}

		public HitCurseRune( Serial serial ) : base( serial )
		{
		}
		...
		public override void GetProperties( ObjectPropertyList list )
		{
			...
			list.Add( 1113699, this.BaseAmount.ToString() ); // Hit Curse ~1_val~%
		}
				...
				if ( item is BaseWeapon )
				{
					...
					else
					{
						...
						if ( item is BaseWeapon )
						{
							...
							if ( i.WeaponAttributes.HitCurse + value <= max )
								i.WeaponAttributes.HitCurse += value;
							else
								i.WeaponAttributes.HitCurse = max;
						}
