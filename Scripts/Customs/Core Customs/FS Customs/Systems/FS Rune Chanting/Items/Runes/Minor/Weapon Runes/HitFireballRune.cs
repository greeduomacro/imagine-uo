...
{
	public class HitFireballRune : BaseMinorRune
	{
		[Constructable]
		public HitFireballRune() : base()
		{
			BaseAmount = 1;
			MaxAmount = 50;
		}
		...
		public override void GetProperties( ObjectPropertyList list )
		{
			...
			list.Add( 1060420, this.BaseAmount.ToString() ); // hit fireball ~1_val~%
		}
				...
				if ( item is BaseWeapon )
				{
					...
					else
					{
						...
						if ( item is BaseWeapon )
						{
							...
							if ( i.WeaponAttributes.HitFireball + value <= max )
								i.WeaponAttributes.HitFireball += value;
							else
								i.WeaponAttributes.HitFireball = max;
						}
