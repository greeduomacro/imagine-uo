...
{
	public class HitLowerAttackRune : BaseMinorRune
	{
		[Constructable]
		public HitLowerAttackRune() : base()
		{
			BaseAmount = 1;
			MaxAmount = 50;
		}
		...
		public override void GetProperties( ObjectPropertyList list )
		{
			...
			list.Add( 1060424, this.BaseAmount.ToString() ); // hit lower attack ~1_val~%
		}
				...
				if ( item is BaseWeapon )
				{
					...
					else
					{
						...
						if ( item is BaseWeapon )
						{
							...
							if ( i.WeaponAttributes.HitLowerAttack + value <= max )
								i.WeaponAttributes.HitLowerAttack += value;
							else
								i.WeaponAttributes.HitLowerAttack = max;
						}
