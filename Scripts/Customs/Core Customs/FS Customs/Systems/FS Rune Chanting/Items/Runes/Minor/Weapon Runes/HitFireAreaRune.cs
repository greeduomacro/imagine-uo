...
{
	public class HitFireAreaRune : BaseMinorRune
	{
		[Constructable]
		public HitFireAreaRune() : base()
		{
			BaseAmount = 1;
			MaxAmount = 50;
		}
		...
		public override void GetProperties( ObjectPropertyList list )
		{
			...
			list.Add( 1060419, this.BaseAmount.ToString() ); // hit fire area ~1_val~%
		}
				...
				if ( item is BaseWeapon )
				{
					...
					else
					{
						...
						if ( item is BaseWeapon )
						{
							...
							if ( i.WeaponAttributes.HitFireArea + value <= max )
								i.WeaponAttributes.HitFireArea += value;
							else
								i.WeaponAttributes.HitFireArea = max;
						}
