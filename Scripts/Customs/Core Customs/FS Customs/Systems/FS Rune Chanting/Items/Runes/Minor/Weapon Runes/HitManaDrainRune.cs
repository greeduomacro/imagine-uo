...
{
	public class HitManaDrainRune : BaseMinorRune
	{
		[Constructable]
		public HitManaDrainRune() : base()
		{
			BaseAmount = 1;
			MaxAmount = 50;
		}

		public HitManaDrainRune( Serial serial ) : base( serial )
		{
		}
		...
		public override void GetProperties( ObjectPropertyList list )
		{
			...
			list.Add( 1113699, this.BaseAmount.ToString() ); // Hit Mana Drain ~1_val~%
		}
				...
				if ( item is BaseWeapon )
				{
					...
					else
					{
						...
						if ( item is BaseWeapon )
						{
							...
							if ( i.WeaponAttributes.HitManaDrain + value <= max )
								i.WeaponAttributes.HitManaDrain += value;
							else
								i.WeaponAttributes.HitManaDrain = max;
						}
