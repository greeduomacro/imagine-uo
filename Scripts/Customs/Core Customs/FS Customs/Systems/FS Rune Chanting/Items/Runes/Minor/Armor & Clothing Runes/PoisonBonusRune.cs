...
{
	public class PoisonBonusRune : BaseMinorRune
	{
		[Constructable]
		public PoisonBonusRune() : base()
		{
			BaseAmount = 1;
			MaxAmount = 15;
		}

		public PoisonBonusRune( Serial serial ) : base( serial )
		{
		}
		...
		public override void GetProperties( ObjectPropertyList list )
		{
			...
			list.Add( 1060449, this.BaseAmount.ToString() ); // poison resist ~1_val~%
		}
