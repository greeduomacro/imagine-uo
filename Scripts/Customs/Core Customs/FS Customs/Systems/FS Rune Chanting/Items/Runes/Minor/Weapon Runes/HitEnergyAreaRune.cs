...
{
	public class HitEnergyAreaRune : BaseMinorRune
	{
		[Constructable]
		public HitEnergyAreaRune() : base()
		{
			BaseAmount = 1;
			MaxAmount = 50;
		}
		...
		public override void GetProperties( ObjectPropertyList list )
		{
			...
			list.Add( 1060418, this.BaseAmount.ToString() ); // hit energy area ~1_val~%
		}
				...
				if ( item is BaseWeapon )
				{
					...
					else
					{
						...
						if ( item is BaseWeapon )
						{
							...
							if ( i.WeaponAttributes.HitEnergyArea + value <= max )
								i.WeaponAttributes.HitEnergyArea += value;
							else
								i.WeaponAttributes.HitEnergyArea = max;
						}
