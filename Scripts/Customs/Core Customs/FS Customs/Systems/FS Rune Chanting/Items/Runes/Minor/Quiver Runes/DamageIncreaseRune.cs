...
{
	public class DamageIncreaseRune : BaseMinorRune
	{
		[Constructable]
		public DamageIncreaseRune() : base()
		{
			BaseAmount = 1;
			MaxAmount = 30;
		}

		public DamageIncreaseRune( Serial serial ) : base( serial )
		{
		}
		...
		public override void GetProperties( ObjectPropertyList list )
		{
			...
			list.Add( 1074762, this.BaseAmount.ToString() ); // Damage modifier: ~1_PERCENT~%
		}
				...
				if ( item is BaseQuiver )
				{
					...
					else
					{
						...
						if ( item is BaseQuiver )
						{
							...
							if ( i.DamageIncrease + value <= max )
								i.DamageIncrease += value;
							else
								i.DamageIncrease = max;
						}
