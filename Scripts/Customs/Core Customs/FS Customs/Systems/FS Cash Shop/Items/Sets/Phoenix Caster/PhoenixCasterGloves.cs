...
{
	public class PhoenixCasterGloves : LeatherGloves
	{
		...
		[Constructable]
		public PhoenixCasterGloves() : base()
		{
			Name = "a blazing phoenix leather gloves";
		...
		public PhoenixCasterGloves( Serial serial ) : base( serial )
		{
		}
