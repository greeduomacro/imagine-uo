...
{
	public class PhoenixCasterSleeves : LeatherArms
	{
		...
		[Constructable]
		public PhoenixCasterSleeves() : base()
		{
			Name = "a blazing phoenix leather sleeves";
		...
		public PhoenixCasterSleeves( Serial serial ) : base( serial )
		{
		}
