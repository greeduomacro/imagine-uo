...
namespace Server.Items
{
	public class TreasureMap : MapItem
	{
		...
		{
			new Type[]{ typeof( HeadlessOne ), typeof( Skeleton ), typeof( Zombie ), typeof( Ratman ), typeof( Mongbat ) },
			...
			new Type[]{ typeof( BloodElemental ), typeof( ElderGazer ), typeof( Daemon ), typeof( LichLord ), typeof( PoisonElemental ) },
			new Type[]{ typeof( AncientWyrm ), typeof( Balron ), typeof( BloodElemental ), typeof( ColdDrake ), typeof( GreaterDragon ), typeof( PoisonElemental ), typeof( Titan ) },
			new Type[]{ typeof( BloodElemental ), typeof( ColdDrake ), typeof( FrostDragon ), typeof( GreaterDragon ), typeof( PoisonElemental ) }
		};

		private static Type[][] m_SpawnTypesIlshenar = new Type[][]
		{
			new Type[]{ typeof( HeadlessOne ), typeof( Skeleton ), typeof( Zombie ), typeof( Ratman ), typeof( Mongbat ) },
			new Type[]{ typeof( EarthElemental ), typeof( Gazer ), typeof( Gargoyle ), typeof( HellHound ), typeof( OrcishMage ) },
			new Type[]{ typeof( AirElemental ), typeof( DreadSpider ), typeof( FireElemental ), typeof( Lich ), typeof( OgreLord ) },
			...
			new Type[]{ typeof( RenegadeChangeling ), typeof( ExodusMinion ), typeof( GargoyleDestroyer ), typeof( GargoyleEnforcer ), typeof( Titan ) }
		};

		private static Type[][] m_SpawnTypesMalas = new Type[][]
		{
			new Type[]{ typeof( HeadlessOne ), typeof( Skeleton ), typeof( Zombie ), typeof( Ratman ), typeof( Mongbat ) },
			new Type[]{ typeof( EarthElemental ), typeof( Gazer ), typeof( Gargoyle ), typeof( HellHound ), typeof( OrcishMage ) },
			new Type[]{ typeof( AirElemental ), typeof( DreadSpider ), typeof( FireElemental ), typeof( Lich ), typeof( OgreLord ) },
			...
			new Type[]{ typeof( Devourer ), typeof( MinotaurCaptain ), typeof( RottingCorpse ), typeof( WandererOfTheVoid ) },
			new Type[]{ typeof( Devourer ), typeof( MinotaurScout ), typeof( MinotaurCaptain ), typeof( RottingCorpse ), typeof( WandererOfTheVoid ) }
		};

		private static Type[][] m_SpawnTypesTokuno = new Type[][]
		{
			new Type[]{ typeof( HeadlessOne ), typeof( Skeleton ), typeof( Zombie ), typeof( Ratman ), typeof( Mongbat ) },
			new Type[]{ typeof( EarthElemental ), typeof( Gazer ), typeof( Gargoyle ), typeof( HellHound ), typeof( OrcishMage ) },
			new Type[]{ typeof( AirElemental ), typeof( DreadSpider ), typeof( FireElemental ), typeof( Lich ), typeof( OgreLord ) },
			...
			new Type[]{ typeof( Yamandon ), typeof( Hiryu ), typeof( LadyOfTheSnow ), typeof( RuneBeetle ), typeof( YomotsuPriest ) }
		};

		private static Type[][] m_SpawnTypesTerMur = new Type[][]
		{
			...
			if ( level >= 0 && level < m_SpawnTypes.Length )
			{
				...
				try
				{
					if ( map == Map.Felucca || map == Map.Trammel )
						...
						bc = (BaseCreature)Activator.CreateInstance( m_SpawnTypesIlshenar[level][Utility.Random( m_SpawnTypesIlshenar[level].Length )] );
					else if ( map == Map.Malas )
						bc = (BaseCreature)Activator.CreateInstance( m_SpawnTypesMalas[level][Utility.Random( m_SpawnTypesMalas[level].Length )] );
					else if ( map == Map.Tokuno )
						bc = (BaseCreature)Activator.CreateInstance( m_SpawnTypesTokuno[level][Utility.Random( m_SpawnTypesTokuno[level].Length )] );
					else if ( map == Map.TerMur )
						bc = (BaseCreature)Activator.CreateInstance( m_SpawnTypesTerMur[level][Utility.Random( m_SpawnTypesTerMur[level].Length )] );
					else
						bc = (BaseCreature)Activator.CreateInstance( m_SpawnTypesTerMur[level][Utility.Random( m_SpawnTypesTerMur[level].Length )] );
				}
				catch
