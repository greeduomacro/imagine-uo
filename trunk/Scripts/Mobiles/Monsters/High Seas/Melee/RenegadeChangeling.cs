...
namespace Server.Mobiles
{
	...
	{
		[Constructable]
		public RenegadeChangeling() : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.1, 0.4 )
		{
			...
			SetSkill( SkillName.Wrestling, 122.1 );
			SetSkill( SkillName.Tactics, 129.9 );
			SetSkill( SkillName.MagicResist, 137.8 );
			SetSkill( SkillName.Magery, 111.6 );
			SetSkill( SkillName.EvalInt, 109.4 );
			SetSkill( SkillName.Meditation, 114.3 );
		...
		public RenegadeChangeling( Serial serial ) : base( serial )
		{
		}
