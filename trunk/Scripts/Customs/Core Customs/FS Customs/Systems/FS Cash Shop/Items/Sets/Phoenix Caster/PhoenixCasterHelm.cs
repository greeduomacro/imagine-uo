...
{
	public class PhoenixCasterHelm : LeatherCap
	{
		...
		[Constructable]
		public PhoenixCasterHelm() : base()
		{
			Name = "a blazing phoenix leather cap";
		...
		public PhoenixCasterHelm( Serial serial ) : base( serial )
		{
		}
