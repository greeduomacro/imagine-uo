...
namespace Server.Items
{
	public class BlueSoulstoneToken : PromotionalToken
	{
		...
		public override TextDefinition ItemName { get { return 1078835; } } // Blue Soulstone
		...
		[Constructable]
		public BlueSoulstoneToken() : base()
		{
		}

		public BlueSoulstoneToken( Serial serial ) : base( serial )
		{
		}
