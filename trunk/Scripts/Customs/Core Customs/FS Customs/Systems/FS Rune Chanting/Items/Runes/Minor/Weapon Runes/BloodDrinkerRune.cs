...
{
	public class BloodDrinkerRune : BaseMinorRune
	{
		[Constructable]
		public BloodDrinkerRune() : base()
		{
			BaseAmount = 1;
			MaxAmount = 1;
		}

		public BloodDrinkerRune( Serial serial ) : base( serial )
		{
		}
		...
		public override void GetProperties( ObjectPropertyList list )
		{
			...
			list.Add( 1113591, this.BaseAmount.ToString() ); // Blood Drinker
		}
				...
				if ( item is BaseWeapon )
				{
					...
					else
					{
						...
						if ( item is BaseWeapon )
						{
							...
							if ( i.WeaponAttributes.BloodDrinker + value <= max )
								i.WeaponAttributes.BloodDrinker += value;
							else
								i.WeaponAttributes.BloodDrinker = max;
						}
