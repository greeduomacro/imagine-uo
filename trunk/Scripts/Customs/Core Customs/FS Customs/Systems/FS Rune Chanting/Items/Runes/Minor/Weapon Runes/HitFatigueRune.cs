...
{
	public class HitFatigueRune : BaseMinorRune
	{
		[Constructable]
		public HitFatigueRune() : base()
		{
			BaseAmount = 1;
			MaxAmount = 50;
		}

		public HitFatigueRune( Serial serial ) : base( serial )
		{
		}
		...
		public override void GetProperties( ObjectPropertyList list )
		{
			...
			list.Add( 1113700, this.BaseAmount.ToString() ); // Hit Fatigue ~1_val~%
		}
				...
				if ( item is BaseWeapon )
				{
					...
					else
					{
						...
						if ( item is BaseWeapon )
						{
							...
							if ( i.WeaponAttributes.HitFatigue + value <= max )
								i.WeaponAttributes.HitFatigue += value;
							else
								i.WeaponAttributes.HitFatigue = max;
						}
