...
{
	public class HitDispelRune : BaseMinorRune
	{
		[Constructable]
		public HitDispelRune() : base()
		{
			BaseAmount = 1;
			MaxAmount = 50;
		}
		...
		public override void GetProperties( ObjectPropertyList list )
		{
			...
			list.Add( 1060417, this.BaseAmount.ToString() ); // hit dispel ~1_val~%
		}
				...
				if ( item is BaseWeapon )
				{
					...
					else
					{
						...
						if ( item is BaseWeapon )
						{
							...
							if ( i.WeaponAttributes.HitDispel + value <= max )
								i.WeaponAttributes.HitDispel += value;
							else
								i.WeaponAttributes.HitDispel = max;
						}
