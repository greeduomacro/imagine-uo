...
{
	public class HitPoisonAreaRune : BaseMinorRune
	{
		[Constructable]
		public HitPoisonAreaRune() : base()
		{
			BaseAmount = 1;
			MaxAmount = 50;
		}
		...
		public override void GetProperties( ObjectPropertyList list )
		{
			...
			list.Add( 1060429, this.BaseAmount.ToString() ); // hit poison area ~1_val~%
		}
				...
				if ( item is BaseWeapon )
				{
					...
					else
					{
						...
						if ( item is BaseWeapon )
						{
							...
							if ( i.WeaponAttributes.HitPoisonArea + value <= max )
								i.WeaponAttributes.HitPoisonArea += value;
							else
								i.WeaponAttributes.HitPoisonArea = max;
						}
