...
{
	public class HitPhysicalAreaRune : BaseMinorRune
	{
		[Constructable]
		public HitPhysicalAreaRune() : base()
		{
			BaseAmount = 1;
			MaxAmount = 50;
		}

		public HitPhysicalAreaRune( Serial serial ) : base( serial )
		{
		}
		...
		public override void GetProperties( ObjectPropertyList list )
		{
			...
			list.Add( 1060428, this.BaseAmount.ToString() ); // hit physical area ~1_val~%
		}
				...
				if ( item is BaseWeapon )
				{
					...
					else
					{
						...
						if ( item is BaseWeapon )
						{
							...
							if ( i.WeaponAttributes.HitPhysicalArea + value <= max )
								i.WeaponAttributes.HitPhysicalArea += value;
							else
								i.WeaponAttributes.HitPhysicalArea = max;
						}
