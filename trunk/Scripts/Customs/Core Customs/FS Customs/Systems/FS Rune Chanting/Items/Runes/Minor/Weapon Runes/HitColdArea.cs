...
{
	public class HitColdAreaRune : BaseMinorRune
	{
		[Constructable]
		public HitColdAreaRune() : base()
		{
			BaseAmount = 1;
			MaxAmount = 50;
		}
		...
		public override void GetProperties( ObjectPropertyList list )
		{
			...
			list.Add( 1060416, this.BaseAmount.ToString() ); // hit cold area ~1_val~%
		}
				...
				if ( item is BaseWeapon )
				{
					...
					else
					{
						...
						if ( item is BaseWeapon )
						{
							...
							if ( i.WeaponAttributes.HitColdArea + value <= max )
								i.WeaponAttributes.HitColdArea += value;
							else
								i.WeaponAttributes.HitColdArea = max;
						}
