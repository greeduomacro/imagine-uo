...
{
	public class BattleLustRune : BaseMinorRune
	{
		[Constructable]
		public BattleLustRune() : base()
		{
			BaseAmount = 1;
			MaxAmount = 1;
		}

		public BattleLustRune( Serial serial ) : base( serial )
		{
		}
		...
		public override void GetProperties( ObjectPropertyList list )
		{
			...
			list.Add( 1113710, this.BaseAmount.ToString() ); // Battle Lust
		}
				...
				if ( item is BaseWeapon )
				{
					...
					else
					{
						...
						if ( item is BaseWeapon )
						{
							...
							if ( i.WeaponAttributes.BattleLust + value <= max )
								i.WeaponAttributes.BattleLust += value;
							else
								i.WeaponAttributes.BattleLust = max;
						}
