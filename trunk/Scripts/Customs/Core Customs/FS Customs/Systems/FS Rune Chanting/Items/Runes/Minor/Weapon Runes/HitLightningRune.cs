...
{
	public class HitLightningRune : BaseMinorRune
	{
		[Constructable]
		public HitLightningRune() : base()
		{
			BaseAmount = 1;
			MaxAmount = 50;
		}
		...
		public override void GetProperties( ObjectPropertyList list )
		{
			...
			list.Add( 1060423, this.BaseAmount.ToString() ); // hit lightning ~1_val~%
		}
				...
				if ( item is BaseWeapon )
				{
					...
					else
					{
						...
						if ( item is BaseWeapon )
						{
							...
							if ( i.WeaponAttributes.HitLightning + value <= max )
								i.WeaponAttributes.HitLightning += value;
							else
								i.WeaponAttributes.HitLightning = max;
						}
