...
{
	public class CastRecoveryRune : BaseMinorRune
	{
		[Constructable]
		...
		public CastRecoveryRune( Serial serial ) : base( serial )
		{
		}
		...
		public override void GetProperties( ObjectPropertyList list )
		{
			...
			list.Add( 1060412, this.BaseAmount.ToString() ); // faster cast recovery ~1_val~
		}
