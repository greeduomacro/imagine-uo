...
{
	public class HitMagicArrowRune : BaseMinorRune
	{
		[Constructable]
		public HitMagicArrowRune() : base()
		{
			BaseAmount = 1;
			MaxAmount = 50;
		}
		...
		public override void GetProperties( ObjectPropertyList list )
		{
			...
			list.Add( 1060426, this.BaseAmount.ToString() ); // hit magic arrow ~1_val~%
		}
				...
				if ( item is BaseWeapon )
				{
					...
					else
					{
						...
						if ( item is BaseWeapon )
						{
							...
							if ( i.WeaponAttributes.HitMagicArrow + value <= max )
								i.WeaponAttributes.HitMagicArrow += value;
							else
								i.WeaponAttributes.HitMagicArrow = max;
						}
