...
namespace Server.Engines.Craft
{
	public class DefInscription : CraftSystem
	{
		...
		private enum Reg{ BlackPearl, Bloodmoss, Garlic, Ginseng, MandrakeRoot, Nightshade, SulfurousAsh, SpidersSilk, DaemonBone, FertileDirt, DragonBlood, Bone }
		...
		{
			int index = AddCraft( type, "Spells of Mysticism", spell, minSkill, minSkill + 1.0, regs[0], 1020000 + CraftItem.ItemIDOf( regs[0] ), 1, 501627 );	//Yes, on OSI it's only 1.0 skill diff'.  Don't blame me, blame OSI.
		...
		public override void InitCraftList()
		{
			...
			if ( Core.ML )
			{
				...
				//Mysticism Scrolls
				AddMysticSpell( "Nether Bolt", 4, 0.0, typeof( NetherBoltScroll ), Reagent.SulfurousAsh, Reagent.BlackPearl );
				AddMysticSpell( "Healing Stone", 4, 0.0, typeof( HealingStoneScroll ), Reagent.Bone, Reagent.Garlic, Reagent.Ginseng, Reagent.SpidersSilk );
				AddMysticSpell( "Purge Magic", 6, 0.0, typeof( PurgeMagicScroll ), Reagent.FertileDirt, Reagent.Garlic, Reagent.MandrakeRoot, Reagent.SulfurousAsh );
				AddMysticSpell( "Enchant", 6, 0.0, typeof( EnchantScroll ), Reagent.SpidersSilk, Reagent.MandrakeRoot, Reagent.SulfurousAsh );
				AddMysticSpell( "Sleep", 9, 3.5, typeof( SleepScroll ), Reagent.SpidersSilk, Reagent.BlackPearl, Reagent.Nightshade );
				AddMysticSpell( "Eagle Strike", 9, 3.5, typeof( EagleStrikeScroll ), Reagent.SpidersSilk, Reagent.Bloodmoss, Reagent.MandrakeRoot, Reagent.Bone );
				AddMysticSpell( "Animated Weapon", 11, 17.8, typeof( AnimatedWeaponScroll ), Reagent.Bone, Reagent.BlackPearl, Reagent.MandrakeRoot, Reagent.Nightshade );
				AddMysticSpell( "Stone Form", 11, 17.8, typeof( StoneFormScroll ), Reagent.Bloodmoss, Reagent.FertileDirt, Reagent.Garlic );
				AddMysticSpell( "Spell Trigger", 14, 32.1, typeof( SpellTriggerScroll ), Reagent.SpidersSilk, Reagent.MandrakeRoot, Reagent.Garlic, Reagent.DragonBlood );
				AddMysticSpell( "Mass Sleep", 14, 32.1, typeof( MassSleepScroll ), Reagent.SpidersSilk, Reagent.Nightshade, Reagent.Ginseng );
				AddMysticSpell( "Cleansing Winds", 20, 46.4, typeof( CleansingWindsScroll ), Reagent.Ginseng, Reagent.Garlic, Reagent.DragonBlood, Reagent.MandrakeRoot );
				AddMysticSpell( "Bombard", 20, 46.4, typeof( BombardScroll ), Reagent.Garlic, Reagent.DragonBlood, Reagent.SulfurousAsh, Reagent.Bloodmoss );
				AddMysticSpell( "Spell Plague", 40, 60.7, typeof( SpellPlagueScroll ), Reagent.Garlic, Reagent.DragonBlood, Reagent.MandrakeRoot, Reagent.Nightshade, Reagent.SulfurousAsh, Reagent.DaemonBone );
				AddMysticSpell( "Hail Storm", 40, 60.7, typeof( HailStormScroll ), Reagent.DragonBlood, Reagent.BlackPearl, Reagent.MandrakeRoot, Reagent.Bloodmoss );
				AddMysticSpell( "Nether Cyclone", 50, 75.0, typeof( NetherCycloneScroll ), Reagent.Bloodmoss, Reagent.Nightshade, Reagent.SulfurousAsh, Reagent.MandrakeRoot );
				AddMysticSpell( "Rising Colossus", 50, 75.0, typeof( RisingColossusScroll ), Reagent.DaemonBone, Reagent.FertileDirt, Reagent.DragonBlood, Reagent.Nightshade, Reagent.MandrakeRoot );
				//END
			}
            ...
            //	AddCraft(typeof(SpellweavingBook), 1044294, "Spellweaving book", 50.0, 100.0, typeof(BlankScroll), 1044377, 10, 1044378);
				AddCraft(typeof(MysticBook), 1044294, "Mysticism spellbook", 50.0, 100.0, typeof(BlankScroll), 1044377, 10, 1044378);
			}
			#endregion
